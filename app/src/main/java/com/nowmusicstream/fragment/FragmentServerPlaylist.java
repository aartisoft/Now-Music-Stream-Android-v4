...
import com.nowmusicstream.adapter.AdapterServerPlaylist;
import com.nowmusicstream.asyncTask.LoadServerPlaylist;
...
import com.nowmusicstream.ionicdev.SongByServerPlaylistActivity;
    ...
    private void loadPlaylist() {
        if (methods.isNetworkAvailable()) {
            LoadServerPlaylist loadServerPlaylist = new LoadServerPlaylist(new ServerPlaylistListener() {
                ...
                @Override
                public void onEnd(String success, ArrayList<ItemServerPlayList> arrayListPlaylist) {
                    if (getActivity() != null) {
                        if (success.equals("1")) {
            ...
            loadServerPlaylist.execute(Constant.URL_PLAYLIST + page);
        } else {
